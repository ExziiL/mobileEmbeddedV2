...
class RobotStatistics extends Component {
	...
	getOrientationFromQuaternion(orientation_in_q) {
		var q = new Three.Quaternion(orientation_in_q.x, orientation_in_q.y, orientation_in_q.z, orientation_in_q.w);
		// roll , pitch , yaw
	...
	render() {
		return (
			!this.state.connected && (
				<div className="border w-100 mb-2 mx-md-2 p-2">
